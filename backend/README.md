...
### Recommended workflow when changing models

1. Make changes to SQLAlchemy models in `app/models.py`.
2. Generate an autogenerate migration script and review it before applying:
   ```bash
   alembic revision --autogenerate -m "describe your change"
   # Inspect the generated file under backend/migrations/versions and adjust if needed
   ```
...
This workflow ensures you review autogenerated changes and avoid accidental schema drift. For SQLite, complex ALTER operations may require manual edits in the migration script (create temp table, copy data, drop/rename tables).
